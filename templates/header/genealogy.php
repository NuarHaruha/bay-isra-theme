...
?>
    ...
    <script src="<?php echo get_template_directory_uri(); ?>/library/js/jitc.js"></script>
    <script src="<?php echo get_template_directory_uri(); ?>/library/js/rgraph.js"></script>
</head>
	<body <?php body_class('purple'); ?>><!-- oncontextmenu="return false;"-->
