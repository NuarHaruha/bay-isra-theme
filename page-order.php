...
*/
?>
<?php do_action('mc_order_process',$_REQUEST);?>
				...
				<div id="main" class="span12 clearfix bg-trans" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						...
						<header>
                            ...
                            <h2 class="page-title">
                            <img src="<?php echo get_template_directory_uri().'';?>/library/img/order-purple.png" width="32" style="maring-bottom:10px"/>
                            <?php the_title(); ?></h2>
                            </div>
                        ...
                        <div class="row-fluid">                                                                                   
                            <?php get_template_part('block','userinfostockist');?>                            
                            <?php get_template_part('loop','request');?>
                            <?php the_content();?>   
