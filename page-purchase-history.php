				...
				<div id="main" class="span12 clearfix bg-trans" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						...
						<header>
                            ...
                            <h2 class="page-title">
                            <img src="<?php echo get_template_directory_uri().'';?>/library/img/calendar-purple.png" width="32" style="maring-bottom:10px"/>
                            <?php the_title(); ?></h2>
                            </div>
                        ...
                        <div class="row-fluid">
                            <?php $invoices = mc_get_invoices_by_id($cid); ?>                                                        
                            <?php get_template_part('block','userinfo');?>
                            </div><!-- end.accordion2 -->
                            <?php if (has_invoices($cid)) get_template_part('block','invoicechart');?>
                            <?php get_template_part('loop','invoice');?>
                            <?php the_content();?> 
